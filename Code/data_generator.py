...
from transformers import BertTokenizerFast, RobertaTokenizerFast, TFBertModel, TFRobertaModel, AlbertTokenizerFast
...
class DataGenerator_BERT(Sequence):
    ...
    def __init__(self, user_level_data, subjects_split, set_type,
        ...
        if model_type == "HAN_BERT" or model_type == "Con_HAN":
            # self.tokenizer = BertTokenizerFast.from_pretrained('bert-base-uncased',
            #                                                do_lower_case=True)
            self.tokenizer = BertTokenizerFast.from_pretrained('prajjwal1/bert-tiny',
                                                           do_lower_case=True)
